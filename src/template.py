...
<div id="wrapper"><!-- Wrapper -->
    <div id="main"><!-- Main -->
        <div class="inner">
            <!-- Header -->
            <header id="header"><a class="logo" href="index.html"><strong>{title}</strong></a></header>
            {sections}
        </div><!-- inner -->
    </div><!-- Main -->
</div><!-- Wrapper -->
...
item: str = """
    <figure style="margin:0;">
        <a class="thumb-link" href="{original_href}"
           onclick="openLightbox({section_idx}, {item_idx});
           return false;">
